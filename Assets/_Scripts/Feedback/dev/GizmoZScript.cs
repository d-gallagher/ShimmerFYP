...
public class GizmoZScript : BaseGizmoScript
{
    // Update is called once per frame
    void Update()
    {
        _angleAroundAxis = Target.transform.rotation.eulerAngles.z;
        //if(_isDebug) Debug.Log(_angleAroundAxis);
    ...
    private List<Vector3> GetArcPoints(Vector3 startPoint, float angleToAxis, bool isPositive)
    {
        ...
        for (int i = 0; i < numSegments + 1; i++)
        {
            ...
            points.Add(new Vector3(-x, y, 0.0f) + _origin);
